      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <Link href="/todo" className="text-sm/6 font-semibold transition-all duration-300 hover:bg-indigo-400 hover:rounded-md px-4 py-2 text-white">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight  text-white sm:text-7xl">
              Welcome to the only <span className='text-indigo-500'>hitlist</span> you will ever need
            </h1>
